...
=== Sprache und Region
#TODO# Interne Link auf das Kapitel Kontoverwaltung. Geht das?
Die Sprache stellst Du in der Kontoverwaltung ein.
Die Region, Datum- und Zeitformat können nicht eingestellt werden.
