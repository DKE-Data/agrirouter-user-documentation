...
. Öffne die https://app.agrirouter.com/de[die Anmeldeseite] wie oben beschrieben.
...
[.result]#Wenn du das nächste Mal https://app.agrirouter.com/de[die Anmeldeseite] öffnest, wird sofort deine xref:introduction.adoc/myagrirouter[my agrirouter Seite] angezeigt.#
====
