...
. Wähle *_Login_*.
[.result]#Der Login-Prozess wird gestartet.#
--
...
. Du erhältst nun eine *_E-Mail mit einem Code_* auf die E-Mail-Adresse, mit der du dich beim agrirouter <<benutzerkonto-erstellen, registriert>> hast. Kopiere den Code aus der Mail.
--
[IMPORTANT]
====
<<<<<<< HEAD
...
>>>>>>> c15a6ef (Update how to change email address)
====
...
NOTE: Deine E-Mail-Adresse kann nicht geändert werden. Um diese zu ändern, wende dich mit einer E-Mail an mailto:support@agrirouter.com[support@agrirouter.com]. Nach Prüfung deiner E-Mail-Adresse wird diese für dich geändert und du erhälst Rückmeldung durch unser Support-Team.
