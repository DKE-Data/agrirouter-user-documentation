...
[.result]#Ein Eingabefenster wird angezeigt.#
...
Du zeigst die Inhalte aller Reiter auf einer Seite an wie folgt:
...
Du zeigst den Inhalt des gewählten Reiters an wie folgt:
