...
NOTE: Notiere E-Mail-Adresse und Passwort. Diese benötigst du, um dich am agrirouter anzumelden.
...
. Öffne das https://goto.my-agrirouter.com/app[Formular `Anmelden`].
. Aktiviere die Checkbox "_Angemeldet bleiben_" und melde dich an.
. Wenn du deine Arbeit mit agrirouter beendet hast, schließe den Internetbrowser oder den Reiter mit agrirouter, [.underline]#ohne# dich abzumelden.
...
Im Reiter `Anzeigeeinstellungen` stellst du die GröÃŸe der Bedienelemente ein und aktivierst die Animationen.
...
[.result]#Die Icons, Buttons und Kacheln werden in der maximalen GröÃŸe angezeigt.#
...
Schalte auf Geräten mit kleinem Bildschirm *_GroÃŸe Interaktionselemente_* aus.
====
