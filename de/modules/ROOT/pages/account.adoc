...
WARNING: Alle Einstellungen, Benutzerdaten und Endpunkte werden gelöscht und können nicht wieder hergestellt werden.
...
=== Benachrichtigungen
#TODO# Einführenden Satz und Zusammenfassung der Einstellmöglichkeiten

. Klicke den Button *_Benachrichtigungen_*.
. Aktiviere die gewünschten Optionen.

=== Sprache und Region
#TODO# Sprache und Region kann m.E. gar nicht eingestellt werden.
