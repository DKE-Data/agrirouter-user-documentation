...
Wenn deine Endpunkte also keine Daten mehr empfangen oder versenden können, kannst du dir den Systemstatus des agrirouter anzeigen lassen:
...
NOTE: Die Daten, die nicht versendet werden können, während der agrirouter offline ist, gehen nicht verloren. Sie werden im Postausgang des Endpunktes gespeichert und automatisch versendet, wenn der agrirouter wieder online geht.
