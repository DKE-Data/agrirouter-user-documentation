...
.Notifikation Zenter
image::notofication_center.png[Notifikation Zenter]

.Ansicht nach Datum
image::notofication_center_date.png[Ansicht nach Datum]

.Ansicht nach Type
image::notofication_center_type.png[Ansicht nach Type]

.Ansicht nach Priorität
image::notofication_center_prio.png[Ansicht nach Priorität]
