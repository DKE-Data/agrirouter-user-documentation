...
Die Bedienung ist so einfach und intuitiv gehalten wie möglich; du solltest jedoch vor der Ersteinrichtung den https://my-agrirouter.com/en/agrirouter/quick-start-guide[Quick Start Guide^] und bei der Inbetriebnahme und weiteren Nutzung dieses Online-Handbuch lesen.
