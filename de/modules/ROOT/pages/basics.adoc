...
[.result]#Das Kapitel xref:account.adoc[Konto] beschreibt, wie du das Konto einrichtest und verwaltest.#

Wenn du dich angemeldet hast, wird das <<Dashboard>> angezeigt:
[.result]#Im Dashboard hast du Zugriff auf alle Funktionen des agrirouter.#

Die Benutzeroberfläche richtest Du in den xref:account.adoc#einstellungen[Einstellungen] ein.

Damit Maschinen und Agrarsoftware über den agrirouter Daten austauschen können, musst du sie als <<Endpunkt,Endpunkte>> registrieren.
[.result]#Das Kapitel xref:endpoint.adoc#maschine-verbinden[Maschine verbinden] beschreibt, wie du einen Endpunkt hinzufügst.#

Über <<Route,Routen>> legst du fest, welche Daten der Endpunkt sendet oder empfängt.
[.result]#Den Datenversand richtest du xref:endpoint.adoc#senden-an[so] ein, den Datenempfang xref:endpoint.adoc#empfangen-von[so].#

Du kannst Endpunkte in <<Gruppe, Gruppen>> zusammenfassen, dann musst du das Routing nur xref:endpoint.adoc#senden-an[einmal einrichten].
[.result]#Lies nach, wie du eine xref:group.adoc#gruppe-hinzufügen[Gruppe hinzufügst] und das Routing für die Gruppe xref:group.adoc#senden-an[einrichtest].#
