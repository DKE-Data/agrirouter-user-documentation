...
====
[cols="1,2,4,1,4,4",options="header",]
|=======================================================================================
|# |Name |Beschreibung | Anzahl der DDI's  |Beispiel  |Bemerkung
|0 |GPS Geo Position |GPS Geo-Position (North and East Coordinates) where the telemetry data was measured or logged. |0  | |Deselection is possible
