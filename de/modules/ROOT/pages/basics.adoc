...
Der agrirouter ist ein internetbasiertes und herstellerübergreifendes Portal zum Austausch von Daten zwischen Maschinen und Agrarsoftware.
Obwohl wir die Bedienung einfach und weitgehend intuitiv gehalten haben, solltest du für die Ersteinrichtung den https://my-agrirouter.com/en/agrirouter/quick-start-guide[Quick Start Guide^] und für die Inbetriebnahme diese Anleitung nutzen.
...
[.result]#Hier hast du Zugriff auf alle Funktionen des agrirouter.#

Du kannst die Ansicht deines Dashboards einrichten.
[.result]#Ändere die Einstellungen, wie im Kapitel xref:account.adoc#einstellungen[Einstellungen] beschrieben.#

Maschinen und Agrarsoftware können Daten austauschen, wenn du sie im agrirouter als <<Endpunkt,Endpunkte>> registriert hast.
[.result]#Füge Endpunkte hinzu, wie im Kapitel xref:endpoint.adoc#maschine-verbinden[Maschine verbinden] beschrieben.#

Das <<Route,Routing>> legt fest, welche Daten ein Endpunkt sendet oder empfängt.
