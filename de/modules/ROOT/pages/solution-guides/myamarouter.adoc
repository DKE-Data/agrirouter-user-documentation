...
. Sende die gewünschte(n) Applikationskarte(n) über dein FMIS an deinen AmaTron 4 link:https://manual.agrirouter.com/de/manual/latest/endpoint.html[Endpunkt].
