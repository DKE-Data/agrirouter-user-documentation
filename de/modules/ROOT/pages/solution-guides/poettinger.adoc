...
. Verbinde Pöttinger Connect als eine link:https://manual.agrirouter.com/de/manual/latest/endpoint.html#connect-machine[Maschine, window="blank"] mit deinem agrirouter-Konto und notiere dir den Registrierungscode.
