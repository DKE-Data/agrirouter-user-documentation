...
Die in den folgenden Kapiteln beschriebenen Datentypen sind dem https://www.isobus.net/isobus/dDEntity[ISOBUS Data Dictionary^] entnommen. Sie sind zur besseren Übersichtlichkeit in Kategorien geordnet:
