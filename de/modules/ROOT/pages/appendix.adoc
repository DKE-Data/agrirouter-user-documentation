...
Viele Maschinen können während der Feldarbeit laufend anfallende Maschinen-, Positions- und Prozessparameter in Echtzeit versenden.
...
Wenn du Routen für Endpunkte oder Gruppen erstellst, die Echtzeitdaten verarbeiten können, kannst du wählen, welche Kategorien ausgetauscht werden wählst du aus 12 Kategorien aus, nicht aus 600 Parametern. Damit du die richtige Kategorie wählen kannst, folgt eine Liste aller Kategorien und der ihnen zugeordneten Parameter.
...
musst dann nur aus 12 Kategorien wählen, nicht aus 600 DDIs.
