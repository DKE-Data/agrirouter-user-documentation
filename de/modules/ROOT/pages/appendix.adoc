...
Wie in den Abschnitten xref:endpoint.adoc#detailansicht[Endpunkt] bzw. xref:group.adoc#detailansicht[Gruppe] beschrieben, wählst du bei der Erstellung von Routen eine oder mehrere Kategorien aus.
