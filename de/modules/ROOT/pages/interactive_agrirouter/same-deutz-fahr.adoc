= Interaktion mit der Same-Deutz-Fahr Datenplattform
...
image::interactive_agrirouter/same-deutz-fahr/sdf-connect-agrirouter-1.5-de.png[Select Register, 800]

[start=8]
. Wenn du nicht bereits mit deinem Browser in deinem agrirouter-Konto eingeloggt bist, gib im sich öffnenden Fenster deine agrirouter Login-Daten ein.
