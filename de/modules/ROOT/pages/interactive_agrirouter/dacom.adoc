...
[IMPORTANT]
====
Um DACOM mit deinem agrirouter-Konto verbinden zu können, musst du eine https://https://www.dacom.nl/de/produkte/cloudfarm/#pricing[Cloudfarm Lizenz, window="_blank"] erwerben! Hast du keine DACOM-Lizenz erworben, wird Cloudfarm auch nicht in deiner linken Seitenleiste angezeigt.
====
