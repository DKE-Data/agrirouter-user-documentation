...
Die Fähigkeiten sind vom Endpunkt vorgegeben und können nicht geändert werden.
...
=== Details
Du kannst die Beschreibung des Endpunktes ändern:
...
Um häufiger zu aktualisieren, z.B. wenn du das Postfach beobachtest, gehe vor wie folgt:
...
Um den Endpunkt zu bearbeiten, gehe vor wie folgt:
...
=== Name ändern
Du kannst den Namen des Endpunktes ändern:
