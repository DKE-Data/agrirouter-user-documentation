...
=== Konto verbinden
Verbinde dein Konto mit den Konten anderer Landwirte oder Lohnunternehmen und tausche Daten mit den Maschinen dieser Konten aus.
...
NOTE: Wenn der eingeladene Kontoinhaber deine Einladung annimmt, erhälst du zur Benachrichtigung eine E-Mail.
...
NOTE: Der neue Empfänger ist sofort in der Endpunkteliste sichtbar. Es kann jedoch mehrere Minuten dauern, bis die Datenverbindung erstellt ist, d.h. du Daten an den Empfänger senden kannst.
...
NOTE: Der neue Sender ist sofort in der Endpunkteliste sichtbar. Es kann jedoch mehrere Minuten dauern, bis die Datenverbindung erstellt ist, d.h. der Sender dir Daten senden kann.
...
Erfahre xref:routing.adoc[=> hier] mehr über Gruppen.
