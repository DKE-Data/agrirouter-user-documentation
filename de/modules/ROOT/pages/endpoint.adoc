...
NOTE: Eine Ausnahme bilden ISOBUS-Maschinen. Es wird der Name der Maschine in der Endpunkteliste angezeigt, nicht die Telemetrie-Einheit.
...
Jede Agrarsoftware mit agrirouter-Schnittstelle hat eine Funktion `Mit agrirouter verbinden`.
