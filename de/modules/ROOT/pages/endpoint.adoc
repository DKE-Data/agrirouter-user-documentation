...
NOTE: Auf einem Tablet wird nur die Detailansicht angezeigt. Die Endpunkteliste muss über das Burger-Menü geöffnet werden.

Auf einem Tablet öffnest Du die Endpunkteliste wie folgt:
. Klicke auf das Burger-Menü Icon image:ar_logon-icon.png[logon, 20, 20].
[.result]#Die Endpunkteliste wird eingeblendet.#
