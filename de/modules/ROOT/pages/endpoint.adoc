...
=== Senden an
Abgehende Routen und Sende-Regeln verwaltest du in diesem Reiter. Er enthält eine Liste der Empfänger.
...
NOTE: Die Liste der Empfänger ist auch bei einem neuen Endpunkt nicht leer. Bei Erstellung des Endpunktes wird automatisch ein Standard-Empfänger zugewiesen.
...
NOTE: Der neue Empfänger ist sofort in der Endpunkteliste sichtbar. Es kann jedoch mehrere Minuten dauern, bis die Route betriebsbereit ist, d.h. Daten an den Empfänger gesendet werden können.
...
=== Empfangen von
Eingehende Routen und Empfangs-Regeln verwaltest du in diesem Reiter. Er enthält eine Liste der Sender.
...
NOTE: Die Liste der Sender ist auch bei einem neuen Endpunkt nicht leer. Bei Erstellung des Endpunktes wird automatisch ein Standard-Sender zugewiesen.
...
NOTE: Der neue Sender ist sofort in der Endpunkteliste sichtbar. Es kann jedoch mehrere Minuten dauern, bis die Route betriebsbereit ist, d.h. Daten vom Sender empfangen werden können.
...
. Wähle das Icon *_Support Informationen image:ar_info.icon.png[Supportinformationen, 30, 30] anzeigen_*.
