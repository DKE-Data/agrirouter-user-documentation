...
Das verbundene Konto kann Daten von dir empfangen und Daten an dich senden. Verbundene Konten werden in der Endpunkteliste angezeigt und dort stellst du auch die Routen ein.
