...
NOTE: Schritte 6 und 7 sind optional und können nur durchgeführt werden, wenn Sender und Empfänger Echtzeitdaten verarbeiten können.
...
NOTE: Um ein Mitglied der Gruppe zu bearbeiten, öffne die Endpunkteliste, wähle und bearbeite den Endpunkt (=> Kapitel )
