...
NOTE: Der neue Empfänger ist sofort sichtbar. Es kann jedoch mehrere Minuten dauern, bis das Routing fertiggestellt ist, d.h. der Empfänger Daten von der Gruppe empfangen kann.
...
* Definieren, welche Nachrichten die Mitglieder der Gruppe vom Sender erhalten sollen
...
NOTE: Der neue Sender ist sofort sichtbar. Es kann jedoch mehrere Minuten dauern, bis das Routing fertiggestellt ist, d.h. der Sender Daten an die Gruppe senden kann.
...
NOTE: Beachte, dass das Mitglied aus der Gruppe entfernt, nicht aber gelöscht wird. Endpunkte und Gruppen löscht du in der Endpunkte- bzw. der Gruppenliste.
